...
_EXPANSIONS = {
    ...
    r"\bgang\s+rape\b":                    "Section 70 BNS gang rape",
    r"\brape\b":                           "Section 64 BNS punishment for rape sexual offence",
    r"\battempt\s+to\s+murder\b":             "Section 109 BNS attempt to murder",
    r"\bmurder\b":                         "Section 103 BNS punishment for murder",
    r"\bkidnapping\b":                     "Section 137 BNS kidnapping from lawful guardianship",
    r"\btheft\b":                          "Section 303 BNS punishment for theft",
